...
function App() {
  return (
    ...
    <div className="flex justify-between items-center px-4 md:px-8 py-4 text-sm">
      <a href="#home" className='space-x-4 md:text-base'>John Miecho Catalan Arnad</a>
    ...
    <div className="flex flex-col-reverse md:flex-row flex-1 items-center justify-center px-4 md:px-8 space-y-8  md:space-y-0">
