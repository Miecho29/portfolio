...
<a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    ...
    <div class="flex flex-col justify-between p-4 leading-normal">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Data Engineer Intern At Apteum Mar 2024 - July 2025</h5>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Focused on data maintenance and quality assurance, create a documentation of all issues found on the tool and do maintenance,fixingbugs,implement new function to improve the tool using  PHP and Laravel.</p>
    </div>
</a>
